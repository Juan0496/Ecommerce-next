      ...
      <footer className="bg-white dark:bg-gray-800 lg:p-4 md:p-4 h-screen"  >
        <div className="grid  mx-auto max-w-screen-xl text-center h-[87vh]">
          <div className="self-end sm:pt-6 h-[45vh]">
            <p className="lg:self-center self-end text-gray-500 dark:text-gray-400">Open-source library of over 400+ web components and interactive elements built for better web.</p>
            <ul className="flex flex-wrap justify-center content-end mb-6 text-gray-900 dark:text-white">
              <li>
